...
export default class CreateJob extends React.Component {
    ...
    loadData() {
        ...
        if (param != "" || copyJobParam != "") {
            var link = param != "" ? 'https://advancewebapp.azurewebsites.net/talents/listing/listing/GetJobByToEdit?id=' + param
                : 'https://advancewebapp.azurewebsites.net/talents/listing/listing/GetJobForCopy?id=' + copyJobParam;
    ...
    addUpdateJob() {
        ...
        var cookies = Cookies.get('talentAuthToken');   
        $.ajax({
            url: 'https://advancewebapp.azurewebsites.net/talents/listing/listing/createUpdateJob',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
