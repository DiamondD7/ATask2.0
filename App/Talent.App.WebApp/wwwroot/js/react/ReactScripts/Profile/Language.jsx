...
this.closeEdit()*//*
    ...
    addLanguage() {
        ...
        $.ajax({
            url: 'https://advancewebapp.azurewebsites.net/profile/profile/profile/addLanguage',
            headers: {
    ...
    delLanguage(id,ind) {
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: `https://advancewebapp.azurewebsites.net/profile/profile/profile/deleteLanguage`,
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
    ...
    updateLanguage() {
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'https://advancewebapp.azurewebsites.net/profile/profile/profile/updateLanguage',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
