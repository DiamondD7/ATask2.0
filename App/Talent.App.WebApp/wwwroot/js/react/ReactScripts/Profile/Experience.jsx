...
export default class Experience extends React.Component {
    ...
    addExperience() {
        ...
        $.ajax({
            url: 'https://advancewebapp.azurewebsites.net/profile/profile/profile/addExperience',
            headers: {
    ...
    updateExperience() {
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'https://advancewebapp.azurewebsites.net/profile/profile/profile/updateExperience',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
