...
export default class VerifyClient extends React.Component {
    ...
    savePassword() {
        ...
        let resetUrl = `https://ataskwebapp.azurewebsites.net/identity/authentication/authentication/validateInvitation?recruiterEmail=${recruiterEmail}&clientEmail=${clientEmail}&resetPasswordToken=${resetPasswordToken}`;
