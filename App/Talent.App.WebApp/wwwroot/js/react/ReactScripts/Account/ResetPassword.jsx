...
export default class ResetPassword extends React.Component {
    ...
    checkToken(email, token) {
        ...
        let url = `https://advancewebapp.azurewebsites.net/identity/authentication/authentication/verifyResetPasswordToken?o=${email}&p=${token}`;
        $.ajax({
            url: url,
            type: 'POST',
    ...
    savePassword() {
        ...
        let resetUrl = `https://advancewebapp.azurewebsites.net/identity/authentication/authentication/resetpassword?o=${email}&p=${token}`;
